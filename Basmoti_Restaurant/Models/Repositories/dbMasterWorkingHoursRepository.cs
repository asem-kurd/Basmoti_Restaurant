...
namespace Restaurant.Models.Repositories
{
    public class dbMasterWorkingHoursRepository : IRepository<MasterWorkingHours>
    {
        ...
        public void Update(int Id, MasterWorkingHours entity)
        {
            ...
            data.MasterWorkingHoursDayName = entity.MasterWorkingHoursDayName;
            data.MasterWorkingHoursIsClosed = entity.MasterWorkingHoursIsClosed;
            data.MasterWorkingHoursOpenTime = entity.MasterWorkingHoursOpenTime;
            data.MasterWorkingHoursCloseTime = entity.MasterWorkingHoursCloseTime;
