        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MasterWorkingHoursId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MasterWorkingHoursDayName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MasterWorkingHoursIsClosed = table.Column<bool>(type: "bit", nullable: false),
                    MasterWorkingHoursOpenTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MasterWorkingHoursCloseTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreateId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemSettingPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SystemSettingEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SystemSettingSocialMediaIcon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SystemSettingSocialMediaIconUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SystemSettingMapLocationUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreateId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
